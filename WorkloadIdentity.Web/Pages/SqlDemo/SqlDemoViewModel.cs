...
public class SqlDemoViewModel
{
    ...
    {
        new SelectListItem {Value = "4fd658a4-5631-4ef3-bc86-872484099189", Text = "Customer 01 (Fruits)"},
        new SelectListItem {Value = "2192a328-5042-43c0-9f52-b7ad81b40a65", Text = "Customer 02 (Hardware)"}
    };
